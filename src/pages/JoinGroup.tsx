...
import { findGroupByInviteCode, joinGroupWithCode, subscribeToMyMemberships } from '../services/groups';
  ...
  return (
    <div className="page">
      ...
      <div className="card">
        ...
        <p className="muted">Te invitaron a unirte a este grupo.</p>
        <button className="btn btn-primary" onClick={handleJoin} disabled={joining}>
          {joining ? <Loader2 size={16} className="spin" /> : 'Unirme al grupo'}
        </button>
      </div>
    </div>
  );
